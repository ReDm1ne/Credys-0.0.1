    ...
    <div class="w-full py-4">
        ...
        <div class="bg-white shadow-md rounded-xl overflow-hidden">
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Actualizar Información del Cliente</h3>
                <p class="mt-1 text-sm text-gray-500">Modifique la información del cliente en el formulario a continuación.</p>
            </div>
            ...
            <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div id="general" class="tab-content active">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="apellido_paterno" name="apellido_paterno" value="{{ old('apellido_paterno', $cliente->apellido_paterno) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="apellido_materno" name="apellido_materno" value="{{ old('apellido_materno', $cliente->apellido_materno) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="telefono_particular" name="telefono_particular" value="{{ old('telefono_particular', $cliente->telefono_particular) }}" required pattern="[0-9]{10}"
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="telefono_celular" name="telefono_celular" value="{{ old('telefono_celular', $cliente->telefono_celular) }}" required pattern="[0-9]{10}"
                                       class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"
                                       value="{{ old('fecha_nacimiento', $cliente->fecha_nacimiento instanceof \DateTime || $cliente->fecha_nacimiento instanceof \Carbon\Carbon ? $cliente->fecha_nacimiento->format('Y-m-d') : $cliente->fecha_nacimiento) }}"
                                       required
                                       class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="lugar_nacimiento" name="lugar_nacimiento" required
                                ...
                                @foreach([
                                    ...
                                    <option value="{{ $estado }}" {{ old('lugar_nacimiento', $cliente->lugar_nacimiento) === $estado ? 'selected' : '' }}>{{ $estado }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="estado_civil" name="estado_civil" required
                                ...
                                <option value="Union Libre" {{ old('estado_civil', $cliente->estado_civil) === 'Union Libre' ? 'selected' : '' }}>Unión Libre</option>
                            </select>
                            @error('estado_civil')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex space-x-4">
                                <div class="flex items-center">
                                    <input type="radio" id="sexo_mujer" name="sexo" value="Mujer" {{ old('sexo', $cliente->sexo) == 'Mujer' ? 'checked' : '' }} required
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                    <label for="sexo_mujer" class="ml-2 block text-sm text-gray-700">Mujer</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" id="sexo_hombre" name="sexo" value="Hombre" {{ old('sexo', $cliente->sexo) == 'Hombre' ? 'checked' : '' }} required
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                        ...
                        <div id="conyuge_section" class="col-span-1 md:col-span-2 p-4 bg-gray-50 rounded-xl border border-gray-200 {{ (old('estado_civil', $cliente->estado_civil) === 'Casado' || old('estado_civil', $cliente->estado_civil) === 'Union Libre') ? '' : 'hidden' }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="conyuge_nombre" name="conyuge_nombre" value="{{ old('conyuge_nombre', $cliente->conyuge_nombre) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="conyuge_telefono" name="conyuge_telefono" value="{{ old('conyuge_telefono', $cliente->conyuge_telefono) }}" pattern="[0-9]{10}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="conyuge_trabajo" name="conyuge_trabajo" value="{{ old('conyuge_trabajo', $cliente->conyuge_trabajo) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="conyuge_direccion_trabajo" name="conyuge_direccion_trabajo" value="{{ old('conyuge_direccion_trabajo', $cliente->conyuge_direccion_trabajo) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    @if($cliente->conyuge_foto)
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">Foto actual:</p>
                                            <img src="{{ asset('storage/conyuge_fotos/' . $cliente->conyuge_foto) }}" alt="Foto del Cónyuge" class="w-20 h-20 object-cover rounded-lg mt-1">
                                        </div>
                                    @endif
                                    @error('conyuge_foto')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="file" id="conyuge_identificacion" name="conyuge_identificacion" accept="image/*"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG. <span class="font-semibold text-red-600">Tamaño máximo: 8MB</span></p>
                                    @if($cliente->conyuge_identificacion)
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">Identificación actual:</p>
                                            <img src="{{ asset('storage/conyuge_identificacions/' . $cliente->conyuge_identificacion) }}" alt="Identificación del Cónyuge" class="w-20 h-20 object-cover rounded-lg mt-1">
                                        </div>
                                    @endif
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="rfc" name="rfc" value="{{ old('rfc', $cliente->rfc) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            @error('rfc')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="curp" name="curp" value="{{ old('curp', $cliente->curp) }}" required maxlength="18"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            @error('curp')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div id="referencias" class="tab-content hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="referencia1_nombre" name="referencia1_nombre" value="{{ old('referencia1_nombre', $cliente->referencia1_nombre) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="referencia1_telefono" name="referencia1_telefono" value="{{ old('referencia1_telefono', $cliente->referencia1_telefono) }}" required pattern="[0-9]{10}"
                                       class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="text" id="referencia1_domicilio" name="referencia1_domicilio" value="{{ old('referencia1_domicilio', $cliente->referencia1_domicilio) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="referencia2_nombre" name="referencia2_nombre" value="{{ old('referencia2_nombre', $cliente->referencia2_nombre) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="referencia2_telefono" name="referencia2_telefono" value="{{ old('referencia2_telefono', $cliente->referencia2_telefono) }}" required pattern="[0-9]{10}"
                                       class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="text" id="referencia2_domicilio" name="referencia2_domicilio" value="{{ old('referencia2_domicilio', $cliente->referencia2_domicilio) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="ingreso_mensual_promedio" name="ingreso_mensual_promedio" value="{{ old('ingreso_mensual_promedio', $cliente->laboralFinanciera->ingreso_mensual_promedio ?? '') }}" required step="0.01"
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="otros_ingresos_mensuales" name="otros_ingresos_mensuales" value="{{ old('otros_ingresos_mensuales', $cliente->laboralFinanciera->otros_ingresos_mensuales ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="ingreso_promedio_mensual_total" name="ingreso_promedio_mensual_total" value="{{ old('ingreso_promedio_mensual_total', $cliente->laboralFinanciera->total_ingreso_mensual ?? '') }}" readonly
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_alimento" name="gasto_alimento" value="{{ old('gasto_alimento', $cliente->laboralFinanciera->gasto_alimento ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_luz" name="gasto_luz" value="{{ old('gasto_luz', $cliente->laboralFinanciera->gasto_luz ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            @error('gasto_luz')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_telefono" name="gasto_telefono" value="{{ old('gasto_telefono', $cliente->laboralFinanciera->gasto_telefono ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_transporte" name="gasto_transporte" value="{{ old('gasto_transporte', $cliente->laboralFinanciera->gasto_transporte ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_renta" name="gasto_renta" value="{{ old('gasto_renta', $cliente->laboralFinanciera->gasto_renta ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            @error('gasto_renta')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_inversion_negocio" name="gasto_inversion_negocio" value="{{ old('gasto_inversion_negocio', $cliente->laboralFinanciera->gasto_inversion_negocio ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_otros_creditos" name="gasto_otros_creditos" value="{{ old('gasto_otros_creditos', $cliente->laboralFinanciera->gasto_otros_creditos ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="gasto_otros" name="gasto_otros" value="{{ old('gasto_otros', $cliente->laboralFinanciera->gasto_otros ?? '') }}" required step="0.01"
                                       class="w-full pl-8 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            @error('gasto_otros')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="total_gasto_mensual" name="total_gasto_mensual" value="{{ old('total_gasto_mensual', $cliente->laboralFinanciera->total_gasto_mensual ?? '') }}" readonly
                                       class="w-full pl-8 px-3 py-2 bg-gray-50 border border-gray-300 rounded-xl shadow-sm">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="total_disponible_mensual" name="total_disponible_mensual" value="{{ old('total_disponible_mensual', $cliente->laboralFinanciera->total_disponible_mensual ?? '') }}" readonly
                                       class="w-full pl-8 px-3 py-2 bg-gray-50 border border-gray-300 rounded-xl shadow-sm">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="tipo_vivienda" name="tipo_vivienda" required
                                ...
                                <option value="Familiar" {{ old('tipo_vivienda', $cliente->laboralFinanciera->tipo_vivienda ?? '') === 'Familiar' ? 'selected' : '' }}>Familiar</option>
                                <option value="Propia" {{ old('tipo_vivienda', $cliente->laboralFinanciera->tipo_vivienda ?? '') === 'Propia' ? 'selected' : '' }}>Propia</option>
                                <option value="Rentada" {{ old('tipo_vivienda', $cliente->laboralFinanciera->tipo_vivienda ?? '') === 'Rentada' ? 'selected' : '' }}>Rentada</option>
                            </select>
                            @error('tipo_vivienda')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="vehiculo" name="vehiculo" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                <option value="0" {{ old('vehiculo', $cliente->laboralFinanciera->vehiculo ? '1' : '0') == "0" ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('vehiculo', $cliente->laboralFinanciera->vehiculo ? '1' : '0') == "1" ? 'selected' : '' }}>Sí</option>
                            </select>
                            @error('vehiculo')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div id="vehiculo_details" class="col-span-1 md:col-span-2 p-4 bg-gray-50 rounded-xl border border-gray-200 {{ old('vehiculo', $cliente->laboralFinanciera->vehiculo ? '1' : '0') == '1' ? '' : 'hidden' }}">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="vehiculo_marca" class="block text-sm font-medium text-gray-700 mb-1">Marca del Vehículo</label>
                                    <input type="text" id="vehiculo_marca" name="vehiculo_marca" value="{{ old('vehiculo_marca', $cliente->laboralFinanciera->vehiculo_marca ?? '') }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="vehiculo_modelo" name="vehiculo_modelo" value="{{ old('vehiculo_modelo', $cliente->laboralFinanciera->vehiculo_modelo ?? '') }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                <div class="flex items-center">
                                    <input type="checkbox" id="refrigerador" name="refrigerador" value="1" {{ old('refrigerador', $cliente->laboralFinanciera->refrigerador ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="refrigerador" class="ml-2 block text-sm text-gray-700">Refrigerador</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="estufa" name="estufa" value="1" {{ old('estufa', $cliente->laboralFinanciera->estufa ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="estufa" class="ml-2 block text-sm text-gray-700">Estufa</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="lavadora" name="lavadora" value="1" {{ old('lavadora', $cliente->laboralFinanciera->lavadora ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="lavadora" class="ml-2 block text-sm text-gray-700">Lavadora</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="television" name="television" value="1" {{ old('television', $cliente->laboralFinanciera->television ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="television" class="ml-2 block text-sm text-gray-700">Televisión</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="licuadora" name="licuadora" value="1" {{ old('licuadora', $cliente->laboralFinanciera->licuadora ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="licuadora" class="ml-2 block text-sm text-gray-700">Licuadora</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="horno" name="horno" value="1" {{ old('horno', $cliente->laboralFinanciera->horno ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="horno" class="ml-2 block text-sm text-gray-700">Horno</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="computadora" name="computadora" value="1" {{ old('computadora', $cliente->laboralFinanciera->computadora ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="computadora" class="ml-2 block text-sm text-gray-700">Computadora</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="sala" name="sala" value="1" {{ old('sala', $cliente->laboralFinanciera->sala ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="sala" class="ml-2 block text-sm text-gray-700">Sala</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="celular" name="celular" value="1" {{ old('celular', $cliente->laboralFinanciera->celular ?? false) ? 'checked' : '' }}
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                ...
                <div id="laboral" class="tab-content hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex">
                                <select id="tipo_de_trabajo" name="tipo_de_trabajo" required
                                    ...
                                    @foreach($tiposTrabajo as $tipo)
                                        <option value="{{ $tipo->nombre }}" {{ old('tipo_de_trabajo', $cliente->laboralFinanciera->tipo_de_trabajo ?? '') === $tipo->nombre ? 'selected' : '' }}>{{ $tipo->nombre }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="nombre_de_la_empresa" name="nombre_de_la_empresa" value="{{ old('nombre_de_la_empresa', $cliente->laboralFinanciera->nombre_de_la_empresa ?? '') }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="rfc_de_la_empresa" name="rfc_de_la_empresa" value="{{ old('rfc_de_la_empresa', $cliente->laboralFinanciera->rfc_de_la_empresa ?? '') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="telefono_empresa" name="telefono_empresa" value="{{ old('telefono_empresa', $cliente->laboralFinanciera->telefono_empresa ?? '') }}" pattern="[0-9]{10}"
                                       class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="text" id="direccion_de_la_empresa" name="direccion_de_la_empresa" value="{{ old('direccion_de_la_empresa', $cliente->laboralFinanciera->direccion_de_la_empresa ?? '') }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <textarea id="referencia_de_la_empresa" name="referencia_de_la_empresa" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('referencia_de_la_empresa', $cliente->laboralFinanciera->referencia_de_la_empresa ?? '') }}</textarea>
                ...
                <div id="documentacion" class="tab-content hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->foto_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Foto actual:</p>
                                    <img src="{{ asset('storage/foto_clientes/' . $cliente->documentacion->foto_cliente) }}" alt="Foto del Cliente" class="w-20 h-20 object-cover rounded-lg mt-1">
                                </div>
                            @endif
                            @error('foto_cliente')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="file" id="identificacion_frente_cliente" name="identificacion_frente_cliente" accept="image/*"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG.</p>
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->identificacion_frente_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Identificación actual:</p>
                                    <img src="{{ asset('storage/identificacion_frente_clientes/' . $cliente->documentacion->identificacion_frente_cliente) }}" alt="Identificación Oficial (Frente)" class="w-20 h-20 object-cover rounded-lg mt-1">
                                </div>
                            @endif
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="file" id="identificacion_reverso_cliente" name="identificacion_reverso_cliente" accept="image/*"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG.</p>
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->identificacion_reverso_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Identificación actual:</p>
                                    <img src="{{ asset('storage/identificacion_reverso_clientes/' . $cliente->documentacion->identificacion_reverso_cliente) }}" alt="Identificación Oficial (Reverso)" class="w-20 h-20 object-cover rounded-lg mt-1">
                                </div>
                            @endif
                        ...
                        <div class="col-span-1">
                            ...
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->comprobante_domicilio_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Comprobante actual:</p>
                                    @php
                                    ...
                                    @if(strtolower($extension) === 'pdf')
                                        <a href="{{ asset('storage/comprobante_domicilio_clientes/' . $cliente->documentacion->comprobante_domicilio_cliente) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors mt-1">
                                    ...
                                    @else
                                        <img src="{{ asset('storage/comprobante_domicilio_clientes/' . $cliente->documentacion->comprobante_domicilio_cliente) }}" alt="Comprobante de Domicilio" class="w-20 h-20 object-cover rounded-lg mt-1">
                                    @endif
                                </div>
                            @endif
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="file" id="acta_de_nacimiento_cliente" name="acta_de_nacimiento_cliente" accept="image/*,.pdf"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG, PDF.</p>
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->acta_de_nacimiento_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Acta actual:</p>
                                    @php
                                    ...
                                    @if(strtolower($extension) === 'pdf')
                                        <a href="{{ asset('storage/acta_de_nacimiento_clientes/' . $cliente->documentacion->acta_de_nacimiento_cliente) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors mt-1">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                            </svg>
                                            Ver PDF
                                    ...
                                    @else
                                        <img src="{{ asset('storage/acta_de_nacimiento_clientes/' . $cliente->documentacion->acta_de_nacimiento_cliente) }}" alt="Acta de Nacimiento" class="w-20 h-20 object-cover rounded-lg mt-1">
                                    @endif
                                </div>
                            @endif
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="file" id="curp_cliente" name="curp_cliente" accept="image/*,.pdf"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG, PDF.</p>
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->curp_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">CURP actual:</p>
                                    @php
                                        $extension = pathinfo(storage_path('app/public/curp_clientes/' . $cliente->documentacion->curp_cliente), PATHINFO_EXTENSION);
                                    @endphp

                                    @if(strtolower($extension) === 'pdf')
                                        <a href="{{ asset('storage/curp_clientes/' . $cliente->documentacion->curp_cliente) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors mt-1">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                            </svg>
                                            Ver PDF
                                    ...
                                    @else
                                        <img src="{{ asset('storage/curp_clientes/' . $cliente->documentacion->curp_cliente) }}" alt="CURP (Documento)" class="w-20 h-20 object-cover rounded-lg mt-1">
                                    @endif
                                </div>
                            @endif
                            @error('curp_cliente')
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="file" id="comprobante_ingresos_cliente" name="comprobante_ingresos_cliente" accept="image/*,.pdf"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG, PDF.</p>
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->comprobante_ingresos_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Comprobante actual:</p>
                                    @php
                                    ...
                                    @if(strtolower($extension) === 'pdf')
                                        <a href="{{ asset('storage/comprobante_ingresos_clientes/' . $cliente->documentacion->comprobante_ingresos_cliente) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors mt-1">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                            </svg>
                                            Ver PDF
                                    ...
                                    @else
                                        <img src="{{ asset('storage/comprobante_ingresos_clientes/' . $cliente->documentacion->comprobante_ingresos_cliente) }}" alt="Comprobante de Ingresos" class="w-20 h-20 object-cover rounded-lg mt-1">
                                    @endif
                                </div>
                            @endif
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="file" id="fachada_casa_cliente" name="fachada_casa_cliente" accept="image/*"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG.</p>
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->fachada_casa_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Imagen actual:</p>
                                    <img src="{{ asset('storage/fachada_casa_clientes/' . $cliente->documentacion->fachada_casa_cliente) }}" alt="Fachada de Casa" class="w-20 h-20 object-cover rounded-lg mt-1">
                                </div>
                            @endif
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="file" id="fachada_negocio_cliente" name="fachada_negocio_cliente" accept="image/*"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG.</p>
                            @if(isset($cliente->documentacion) && $cliente->documentacion && $cliente->documentacion->fachada_negocio_cliente)
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Imagen actual:</p>
                                    <img src="{{ asset('storage/fachada_negocio_clientes/' . $cliente->documentacion->fachada_negocio_cliente) }}" alt="Fachada de Negocio" class="w-20 h-20 object-cover rounded-lg mt-1">
                                </div>
                            @endif
                ...
                <div class="mt-6 flex items-center justify-end">
                    ...
                    <button type="submit" id="actualizarClienteBtn" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition duration-300 ease-in-out shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center">
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mostrar/ocultar detalles de vehículo
