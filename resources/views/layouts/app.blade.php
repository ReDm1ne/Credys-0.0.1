    ...
    <div class="container">
        <nav class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="/sucursales" class="submenu-toggle {{ request()->is('sucursales*') ? 'active' : '' }}"><i class="fas fa-building" aria-hidden="true"></i> <span>Sucursales</span></a>
                    <ul class="submenu">
                        <li><a href="/sucursales" class="submenu-toggle {{ request()->is('sucursales*') ? 'active' : '' }}"><span>Administrar Sucursales</span></a></li>
                    </ul>
                </li>
                <li>
                    <a href="#" class="submenu-toggle {{ request()->is('clientes*') ? 'active' : '' }}"><i class="fas fa-users" aria-hidden="true"></i> <span>Administración de clientes</span></a>
                    <ul class="submenu">
                        <li><a href="/clientes/create" class="{{ request()->is('clientes/create*') ? 'active' : '' }}"><span>Alta de Clientes</span></a></li>
                        <li><a href="/clientes" class="{{ request()->is('clientes') ? 'active' : '' }}"><span>Consulta de Clientes</span></a></li>
                ...
                <li>
                    <a href="/empleados" class="submenu-toggle  {{ request()->is('empleado*') ? 'active' : '' }}"><i class="fas fa-user-tie" aria-hidden="true"></i> <span>Administración de empleados</span></a>
                    <ul class="submenu">
                        <li><a href="/empleados/create" class="{{ request()->is('empleado/create*') ? 'active' : '' }}"><span>Alta de empleado</span></a></li>
                        <li><a href="/empleados" class="{{ request()->is('empleado*') ? 'active' : '' }}"><span>Consulta de empleado</span></a></li>
                    </ul>
                </li>
                <li>
