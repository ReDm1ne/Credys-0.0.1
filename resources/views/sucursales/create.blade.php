...
@section('header_title', 'Crear Sucursal')
    ...
    <div class="w-full py-4">
        ...
        <div class="bg-white shadow-md rounded-xl overflow-hidden">
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Nueva Sucursal</h3>
                <p class="mt-1 text-sm text-gray-500">Complete el formulario para crear una nueva sucursal en el sistema.</p>
            </div>

            <form action="{{ route('sucursales.store') }}" method="POST" class="p-6">
                @csrf
